...
namespace CosmicCuration.Player
{
    public class PlayerController
    {
        ...
        public PlayerController(PlayerView playerViewPrefab, PlayerScriptableObject playerScriptableObject, BulletView bulletPrefab, BulletScriptableObject bulletScriptableObject, BulletPool bulletPool)
        {
